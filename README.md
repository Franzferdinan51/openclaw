...
- **[Duck Bot](examples/duck-bot/)** — Full OpenClaw workspace with Duck CLI, AI Council (52 councilors), Agent Teams, CannaAI, and custom skills. Maintained by [Franzferdinan51](https://github.com/Franzferdinan51).
